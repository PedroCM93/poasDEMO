...
<head>
    ...
    <script src='assets/scripts/informs.js'></script>
...
<body class="flex bg-gray-100 min-h-screen font-roboto text-white">
    ...
    <main class="flex-1 flex flex-col px-10 py-6 bg-white text-gray-800">
        ...
        <div class="flex justify-between items-center border-b pb-4">
            <h1 class="text-2xl font-semibold text-gray-700">Reportes de Presupuesto por Área </h1>
        ...
        <div class="flex flex-1 pt-6 justify-around">
            <div>
                <button type="button" class="btn btn-info" id="btnInform" data-fiscalyear="2025" >Generar reporte</button>
            <!-- Field Description -->
